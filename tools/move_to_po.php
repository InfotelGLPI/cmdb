...
if (!is_readable(GLPI_ROOT . "/plugins/cmdb/locales/".$_GET['lang'].".php")) {
   print "Unable to read dictionnary file\n";
   exit();
}
include (GLPI_ROOT . "/plugins/cmdb/locales/en_GB.php");
$REFLANG = $LANG;

$lf     = fopen(GLPI_ROOT . "/plugins/cmdb/locales/".$_GET['lang'].".php", "r");
$lf_new = fopen(GLPI_ROOT . "/plugins/cmdb/locales/temp.php", "w+");
...
include (GLPI_ROOT . "/plugins/cmdb/locales/temp.php");

if (!is_readable(GLPI_ROOT . "/plugins/cmdb/locales/glpi.pot")) {
   print "Unable to read glpi.pot file\n";
   exit();
}
$current_string_plural = '';

$pot = fopen(GLPI_ROOT . "/plugins/cmdb/locales/glpi.pot", "r");
$po  = fopen(GLPI_ROOT . "/plugins/cmdb/locales/".$_GET['lang'].".po", "w+");
