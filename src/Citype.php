...
class CIType extends CommonDropdown
{
    ...
    public function showInAssetTypes()
    {
        global $CFG_GLPI;
...
//    }
     ...
     *
     */
    public function updateDisplayFields($input)
    {
     ...
     * @return array
     */
    public static function getUnallowedFields($itemclass)
    {
     ...
     * @return array
     */
    public function addIcons($donotif, $disablenotif, $id)
    {
        global $CFG_GLPI;
     ...
     *
     */
    public function deleteIcons($key, $id)
    {
        global $DB;
    ...
    public function cleanDBonPurge()
    {
        ...
        $class_filename = ucfirst($sysname) . ".php";
        ...
        $doc = new Document_Item();
        $doc->deleteByCriteria(['itemtype' => CIType::class, 'items_id' => $this->fields['id']], 1);

        $temp = new CIType_Document();
     ...
     * @global type $DB
     */
    public function isLinkedBaseline()
    {
     ...
     * @global  $DB
     */
    public function deleteCIFields()
    {
        $id = $this->fields['id'];
     ...
     * @return array
     */
    public static function getCiTypes()
    {
        global $DB;
     ...
     * @return array
     */
    public function getCiTypesByEntity($entities_id)
    {
        global $DB;
     ...
     */
    public static function getClassname($raw_name = "")
    {
